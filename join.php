...
<head>
    ...
    <form action="15-07member_join.php" method="post"></form>
</head>

<body>

<div class="mu_top">
	<span class="join_text1">회원가입</span>
</div>
<?php 
  include 'login_head.php';
?>
    <form action="15-07_member_join.php" method="post" id="join">
		<b class="id">아이디</b>
        <div class="id_blank">
