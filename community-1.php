<?php
	...
	$bestRecipes = $dao->getBestRecipes;
	...
	// 로그인한 사용자 이름 저장
    // 이 이름과 작성자가 일치할 때만 수정&삭제 버튼이 보이도록 함
...
<div class="container4">
  ...
  <path d="M22 12c-2.667 4.667 -6 7 -10 7s-7.333 -2.333 -10 -7c2.667 -4.667 6 -7 10 -7s7.333 2.333 10 7" />
        ...
        <tr>
            <td class="msg-text2_4" width="200px" style="word-break: break-all;"><?= $row["content"]; ?>
            </td>
        </tr>
</table>
	
        <div class="cm_img"><a href="files/<?= $row["save_name"]?>" target="_blank"><img src="files/<?= $row["save_name"]?>"  onerror="this.style.display='none';" alt="" alt="" width="70px;" height="70px;" class="img_file"/>
        </a></div>
        <br>
...
<div class="submit">
        <input type="button" value="목록보기" class="s_sub3"
		 ...
		 <?php if ($name == $row["writer"] || $loginId ==admin) : ?>
